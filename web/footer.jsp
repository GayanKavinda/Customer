<footer id="footer" class="padding-50 dark">
    <div class="container">
        <div class="row">
            <!-- Our location !-->
            <div class="col-md-3 col-sm-12 col-xs-12 our_location">
                <h3>Our Location</h3>
                <p>Majesty  Head Office:</p>
                <span>142 1st Lane. Weheragampita Rd, Matara. SL</span>
                <p class="mt30">Call for Reservations:<span >(041) 123-4567</span></p>
    ...
    <div class="footer_logo text-center"> <img  src="img/footer_logo.png"  alt="logo">
        <p> 2019 ALL RIGHT RESERVED. DESIGNED BY <a target="_blank" href="#">ITP</a></p>
    </div>
    <!-- End Footer logo !-->
</footer>